...
const ImageSlider = () => {
    return (
        <div className='imageContainer'>
            <div className='imageItem'><img src={img1} alt="" /></div>
            <div className='imageItem'><img src={img2} alt="" /></div>
            <div className='imageItem'><img src={img1} alt="" /></div>
            <div className='imageItem'><img src={img2} alt="" /></div>
            <div className='imageItem'><img src={img3} alt="" /></div>
            <div className='imageItem'><img src={img5} alt="" /></div>
            <div className='imageItem'><img src={img4} alt="" /></div>
        </div>
    );
};
